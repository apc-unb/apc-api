...
func Test301Redirect(t *testing.T) {
	...
	r := NewRouter()
	r.HandleFunc("/apc-unb/apc-api/", func2).Name("func2")
	r.HandleFunc("/", func1).Name("func1")

	req, _ := http.NewRequest("GET", "http://localhost//apc-unb/apc-api/?abc=def", nil)
	...
	if "http://localhost/apc-unb/apc-api/?abc=def" != res.hh["Location"][0] {
